...
using TrainingFoodAnalyser.Models.AccountViewModels;
...
namespace TrainingFoodAnalyser.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public async Task<IActionResult> RefreshToken([FromForm] string authenticationToken,[FromForm] string refreshToken)
		{
